...
<h6 class="fw-bold mb-2">Dados pessoais e identificação</h6>
<div class="row g-3">
...
<hr class="my-4">
<h6 class="fw-bold mb-2">Segunda parte: dados da motorizada</h6>
<div class="row g-3">
<div class="col-md-6"><label class="form-label">Placa da matrícula</label><input class="form-control" name="motorcycle_plate" required></div>
<div class="col-md-6"><label class="form-label">Livrete</label><input class="form-control" name="motorcycle_livrete" required></div>
<div class="col-md-6"><label class="form-label">Modelo</label><input class="form-control" name="motorcycle_model" required></div>
<div class="col-md-3"><label class="form-label">Ano de fabrico</label><input class="form-control" type="number" min="1980" max="2100" name="motorcycle_year" required></div>
<div class="col-md-6"><label class="form-label">Foto frontal da motorizada</label><input class="form-control" type="file" name="motorcycle_front" accept="image/*" required></div>
<div class="col-md-6"><label class="form-label">Foto traseira da motorizada</label><input class="form-control" type="file" name="motorcycle_back" accept="image/*" required></div>
<div class="col-md-6"><label class="form-label">Senha</label><input class="form-control" type="password" name="password" required></div>
</div>

<button class="btn btn-primary mt-3">Criar conta</button>
</form>
</div></div>
